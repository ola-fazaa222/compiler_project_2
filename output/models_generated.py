...
class Product:
    ...
    products = {}
    def __init__(self, name, price, details, image_filename):
    ...
    def to_dict(self):
        ...
        return {"id" : self.id, "name" : self.name, "price" : self.price, "details" : self.details, "image_filename" : self.image_filename, "created_at" : self.created_at.strftime ( '%Y-%m-%d %H:%M:%S' ) }
