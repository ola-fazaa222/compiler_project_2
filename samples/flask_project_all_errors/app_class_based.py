...
<head>
    ...
    <style>
        ...
        .product-grid { display: grid; gap: 20px; padding: 20px; }
        .product-card { width: 300px; background: white; padding: 15px; border-radius: 8px; box-shadow: 0 0 8px #ccc; }
        .price { color: green; font-weight: bold; }
        .btn { display: inline-block; padding: 8px 15px; background: #333; color: white; border-radius: 5px; }
        .btn.delete { background: #b30000; }
        .form { width: 400px; margin: auto; background: white; padding: 20px; border-radius: 8px; }
        .detail-container { display: flex; gap: 30px; padding: 30px; }
        .big-img { height: 200px; object-fit: cover; width: 300px; }
    </style>
</head>
<body>
    <header>
